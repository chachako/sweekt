...
class InfoClassTransformer(context: IrPluginContext, configuration: CompilerConfiguration) :
  AbstractIrTransformer(context, configuration), ModuleLoweringPass, ClassLoweringPass {

  override fun lower(module: IrModuleFragment) {
    module.files.forEach(::lower)
  }
