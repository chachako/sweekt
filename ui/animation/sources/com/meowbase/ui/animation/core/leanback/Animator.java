...
package com.meowbase.ui.animation.core.leanback;
 ...
 */
public abstract class Animator extends android.animation.Animator implements Cloneable {
     ...
     */
    ArrayList<android.animation.Animator.AnimatorListener> mListeners = null;
     ...
     * {@link AnimatorListener#onAnimationStart(android.animation.Animator)} for any listeners of this animator.
     *
     ...
     * {@link AnimatorListener#onAnimationCancel(android.animation.Animator)} to
     * its listeners, followed by an
     * {@link AnimatorListener#onAnimationEnd(android.animation.Animator)} message.
     *
     ...
     * {@link AnimatorListener#onAnimationEnd(android.animation.Animator)} method on
     * its listeners.
     *
     * <p>This method must be called on the thread that is running the animation.</p>
     */
     ...
     * default value is {@link AccelerateDecelerateInterpolator}.
     *
     ...
     */
    @Override
    public void addListener(@NonNull android.animation.Animator.AnimatorListener listener) {
        if (mListeners == null) {
     ...
     *                 animation.
     */
    public void removeListener(@NonNull android.animation.Animator.AnimatorListener listener) {
        if (mListeners == null) {
            return;
        }
     ...
     */
    @Nullable
    public ArrayList<android.animation.Animator.AnimatorListener> getListeners() {
        return mListeners;
    }
   ...
   public void startWithoutPulsing(boolean inReverse) {
     ...
     */
    public interface AnimatorListener extends android.animation.Animator.AnimatorListener {
         ...
         */
        default void onAnimationStart(@NonNull android.animation.Animator animation, boolean isReverse) {
         ...
         * @param isReverse Whether the animation is playing in reverse.
         */
        default void onAnimationEnd(@NonNull android.animation.Animator animation, boolean isReverse) {
    ...
    public interface AnimatorUpdateListener {
         ...
         */
        void onAnimationUpdate(@NonNull android.animation.Animator animation);
