...
public class ValueAnimator extends Animator implements AnimationHandler.AnimationFrameCallback {
     ...
     * playing from that point. {@link com.meowbase.ui.animation.core.leanback.Animator.AnimatorListener} events
     ...
     * {@link com.meowbase.ui.animation.core.leanback.Animator.AnimatorUpdateListener#onAnimationUpdate(android.animation.Animator)},
        ...
        if (mListeners != null && !mStartListenersCalled) {
            ...
            for (int i = 0; i < numListeners; ++i) {
                ...
                if (listener instanceof AnimatorListener) {
                    ((AnimatorListener) listener).onAnimationStart(this, mReversing);
                } else {
    ...
    public void cancel() {
        ...
        if ((mStarted || mRunning) && mListeners != null) {
            ...
            ArrayList<android.animation.Animator.AnimatorListener> tmpListeners =
                    (ArrayList<android.animation.Animator.AnimatorListener>) mListeners.clone();
            for (android.animation.Animator.AnimatorListener listener : tmpListeners) {
     ...
     * iterations,
     * {@link AnimatorListener#onAnimationRepeat(android.animation.Animator)}
     * will be called.
     */
    @Override
