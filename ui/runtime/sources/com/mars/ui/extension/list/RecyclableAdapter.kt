...
import com.mars.ui.extension.list.impl.DataType
import com.mars.ui.extension.list.impl.ItemBinder
import com.mars.ui.extension.list.impl.ItemDefineBlock
import com.mars.ui.extension.list.impl.ItemType
import com.mars.ui.extension.list.impl.data.DataSource
import com.mars.ui.extension.list.impl.data.ItemComparator
import com.mars.ui.extension.list.impl.data.ItemIdentifier
...
open class RecyclableAdapter<S : Any>(
  ...
  override fun submitList(list: MutableList<S>?) {
    super.submitList(list)
    // 提交新的数据源后，我们需要将其转换并注入到 itemClassNames
    resolveItems(list)
  }

  override fun submitList(list: MutableList<S>?, commitCallback: Runnable?) {
