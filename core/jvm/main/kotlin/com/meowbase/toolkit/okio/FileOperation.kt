...
import com.meowbase.toolkit.error
import com.meowbase.toolkit.noSuchFile
 ...
 * @see appendBytes
 */
fun File.appendBytes(block: (origin: ByteArray) -> ByteArray): Unit =
  appendBytes(block(readBytes()))
