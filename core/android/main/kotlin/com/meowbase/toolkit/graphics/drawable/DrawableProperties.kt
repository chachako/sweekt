...
data class DrawableProperties(
  ...
  @JvmField var topLeftRadius: Float = 0f,
  @JvmField var topRightRadius: Float = 0f,
  @JvmField var bottomRightRadius: Float = 0f,
  @JvmField var bottomLeftRadius: Float = 0f,
  ...
  var cornerRadius: Float = _cornerRadius
    set(value) {
      field = value // == _cornerRadius = value
      topLeftRadius = value
  ...
  override fun writeToParcel(parcel: Parcel, flags: Int) {
    ...
    parcel.writeFloat(_cornerRadius)
    parcel.writeFloat(topLeftRadius)
    parcel.writeFloat(topRightRadius)
    parcel.writeFloat(bottomRightRadius)
    parcel.writeFloat(bottomLeftRadius)
