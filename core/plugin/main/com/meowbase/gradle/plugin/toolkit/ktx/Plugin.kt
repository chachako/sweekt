...
/**
 * 注册一个 Plugin
 * @param id 插件的 ID，如 "com.meowbase.gradle.plugin.toolkit"
...
@InternalMeowbaseApi
fun Project.createMeowbasePlugin(pluginName: String = project.name) = createPlugin(
  pluginName = pluginName,
  id = "com.meowbase.gradle.plugin.$pluginName",
  implementationClass = "com.meowbase.gradle.plugin.$pluginName.${pluginName.capitalize()}Plugin"
)