...
object Deps {
  ...
  const val clikt = "com.github.ajalt.clikt:clikt:_"
  ...
  const val kotlinCompiler = "org.jetbrains.kotlin:kotlin-compiler:_"
  const val kotlinEmbeddableCompiler = "org.jetbrains.kotlin:kotlin-compiler-embeddable:_"

  const val arrowIdeaPlugin = "io.arrow-kt:idea-plugin:_"
  const val arrowCompilerPlugin = "io.arrow-kt:compiler-plugin:_"

  val autoService = AutoService

  object AutoService : DependencyNotationAndGroup(group = "com.google.auto.service", name = "auto-service") {
    val annotations = "$artifactPrefix-annotations:_"
  }
