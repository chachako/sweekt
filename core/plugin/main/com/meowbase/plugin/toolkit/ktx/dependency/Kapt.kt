...
fun DependencyHandler.kaptMeowbaseLibraries(vararg artifacts: String) {
  artifacts.forEach { add("kapt", meowbaseLibrary(it)) }
}

fun DependencyHandler.kaptTestMeowbaseLibraries(vararg artifacts: String) {
  artifacts.forEach { add("kaptTest", meowbaseLibrary(it)) }
}

fun DependencyHandler.kaptAndroidTestMeowbaseLibraries(vararg artifacts: String) {
  artifacts.forEach { add("kaptAndroidTest", meowbaseLibrary(it)) }
}